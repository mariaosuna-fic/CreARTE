...
async function cargarUsuariosAlumnos() {
    try {
        ...
        select.innerHTML = '<option value="">Selecciona un usuario con rol alumno</option>';
...
function editarAlumno(id, matricula, telefono, fecha_registro, id_usuario) {
    idAlumnoEditando = id;
...
async function eliminarAlumno(id) {
    ...
    try {
        const respuesta = await fetch(`/alumnos/${id}`, {
            method: 'DELETE'
        });
